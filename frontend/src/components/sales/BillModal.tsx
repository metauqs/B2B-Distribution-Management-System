...
export function BillModal({ sale, client, onClose, onDelete }: BillModalProps) {
  ...
  const handlePrint = () => {
    ...
    w.document.write(`<!DOCTYPE html><html><head>
      <link href="https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,700&family=IBM+Plex+Sans:wght@400;600&family=IBM+Plex+Mono:wght@400;700&family=Noto+Nastaliq+Urdu:wght@700&display=swap" rel="stylesheet">
      <style>
