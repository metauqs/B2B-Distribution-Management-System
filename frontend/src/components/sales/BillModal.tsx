    ...
    w.document.write(`<!DOCTYPE html><html><head>
      ...
      <style>
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .va-urdu{font-family:'Noto Nastaliq Urdu','Noto Sans Arabic','Segoe UI',sans-serif;font-weight:600;direction:rtl;unicode-bidi:isolate;line-height:1.3;letter-spacing:normal!important;text-transform:none!important;}
      ...
      <div className="va-modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="va-bill" id="bill-capture" ref={billRef}>
          ...
          <div className="va-bill-head" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '16px 20px' }}>
            <img src="/logo.png" alt="Halal Vegg Supplies" style={{ height: '48px', width: 'auto', objectFit: 'contain' }} />
          </div>
