...
async function main() {
  ...
  const products = [
    // Vegetables
    { name: 'Tomato',        urduName: 'ٹماٹر',    category: 'vegetable', defaultUnit: Unit.KG,  minStock: 50 },
    { name: 'Potato',        urduName: 'آلو',       category: 'vegetable', defaultUnit: Unit.KG,  minStock: 100 },
    { name: 'Onion',         urduName: 'پیاز',      category: 'vegetable', defaultUnit: Unit.KG,  minStock: 80 },
    { name: 'Garlic',        urduName: 'لہسن',      category: 'vegetable', defaultUnit: Unit.KG,  minStock: 15 },
    { name: 'Ginger',        urduName: 'ادرک',      category: 'vegetable', defaultUnit: Unit.KG,  minStock: 10 },
    { name: 'Green Chilli',  urduName: 'ہری مرچ',   category: 'vegetable', defaultUnit: Unit.KG,  minStock: 20 },
    { name: 'Coriander',     urduName: 'دھنیا',     category: 'vegetable', defaultUnit: Unit.KG,  minStock: 10 },
    { name: 'Cabbage',       urduName: 'بند گوبھی', category: 'vegetable', defaultUnit: Unit.KG,  minStock: 30 },
    { name: 'Cauliflower',   urduName: 'پھول گوبھی',category: 'vegetable', defaultUnit: Unit.PIECE, minStock: 20 },
    { name: 'Carrot',        urduName: 'گاجر',      category: 'vegetable', defaultUnit: Unit.KG,  minStock: 30 },
    { name: 'Peas',          urduName: 'مٹر',       category: 'vegetable', defaultUnit: Unit.KG,  minStock: 20 },
    { name: 'Spinach',       urduName: 'پالک',      category: 'vegetable', defaultUnit: Unit.KG,  minStock: 20 },
    { name: 'Cucumber',      urduName: 'کھیرا',     category: 'vegetable', defaultUnit: Unit.KG,  minStock: 25 },
    { name: 'Brinjal',       urduName: 'بینگن',     category: 'vegetable', defaultUnit: Unit.KG,  minStock: 15 },
    { name: 'Lady Finger',   urduName: 'بھنڈی',    category: 'vegetable', defaultUnit: Unit.KG,  minStock: 15 },
    { name: 'Pumpkin',       urduName: 'کدو',       category: 'vegetable', defaultUnit: Unit.KG,  minStock: 15 },
    { name: 'Bottle Gourd',  urduName: 'لوکی',      category: 'vegetable', defaultUnit: Unit.KG,  minStock: 15 },
    { name: 'Bitter Gourd',  urduName: 'کریلا',     category: 'vegetable', defaultUnit: Unit.KG,  minStock: 15 },
    { name: 'Turnip',        urduName: 'شلجم',      category: 'vegetable', defaultUnit: Unit.KG,  minStock: 10 },
    { name: 'Radish',        urduName: 'مولی',      category: 'vegetable', defaultUnit: Unit.KG,  minStock: 15 },
    { name: 'Beans',         urduName: 'پھلیاں',    category: 'vegetable', defaultUnit: Unit.KG,  minStock: 15 },
    { name: 'Lemon',         urduName: 'لیموں',     category: 'vegetable', defaultUnit: Unit.KG,  minStock: 10 },
    ...
    // Fruits
    { name: 'Apple',         urduName: 'سیب',       category: 'fruit',     defaultUnit: Unit.KG,  minStock: 40 },
    { name: 'Banana',        urduName: 'کیلا',      category: 'fruit',     defaultUnit: Unit.DOZEN, minStock: 20 },
    { name: 'Mango',         urduName: 'آم',        category: 'fruit',     defaultUnit: Unit.KG,  minStock: 30 },
    { name: 'Orange',        urduName: 'مالٹا',     category: 'fruit',     defaultUnit: Unit.DOZEN, minStock: 30 },
    { name: 'Grapes',        urduName: 'انگور',     category: 'fruit',     defaultUnit: Unit.KG,  minStock: 20 },
    { name: 'Watermelon',    urduName: 'تربوز',     category: 'fruit',     defaultUnit: Unit.KG,  minStock: 50 },
    { name: 'Melon',         urduName: 'خربوزہ',     category: 'fruit',     defaultUnit: Unit.KG,  minStock: 30 },
    { name: 'Guava',         urduName: 'امرود',     category: 'fruit',     defaultUnit: Unit.KG,  minStock: 20 },
    { name: 'Papaya',        urduName: 'پیتا',      category: 'fruit',     defaultUnit: Unit.KG,  minStock: 15 },
    { name: 'Pear',          urduName: 'ناشپاتی',    category: 'fruit',     defaultUnit: Unit.KG,  minStock: 15 },
    { name: 'Plum',          urduName: 'آلوبخارا',   category: 'fruit',     defaultUnit: Unit.KG,  minStock: 10 },
    { name: 'Peach',         urduName: 'آڑو',       category: 'fruit',     defaultUnit: Unit.KG,  minStock: 15 },
    { name: 'Pomegranate',   urduName: 'انار',       category: 'fruit',     defaultUnit: Unit.KG,  minStock: 20 },
  ];
